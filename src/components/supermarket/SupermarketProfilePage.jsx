...
const SupermarketProfilePage = () => {
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://swiftora.vercel.app/api/supermarkets/me`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `https://swiftora.vercel.app/api/supermarkets/${userData.supermarketId}`,
        {
          name: userData.name,
